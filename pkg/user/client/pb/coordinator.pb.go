...
var file_coordinator_proto_rawDesc = []byte{
	...
	0x0a, 0x43, 0x61, 0x74, 0x61, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x22, 0x42, 0x0a, 0x04, 0x56,
	...
	0x01, 0x28, 0x08, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x70,
	...
	0x32, 0xb3, 0x03, 0x0a, 0x0b, 0x43, 0x6f, 0x6f, 0x72, 0x64, 0x69, 0x6e, 0x61, 0x74, 0x6f, 0x72,
...
var file_coordinator_proto_goTypes = []interface{}{
	...
	(*View)(nil),              // 7: pb.View
	(*PackagesResponce)(nil),  // 8: pb.PackagesResponce
	(*Category)(nil),          // 9: pb.Category
	(*Package)(nil),           // 10: pb.Package
...
var file_coordinator_proto_depIdxs = []int32{
	...
	9,  // 1: pb.Catagories.Catagories:type_name -> pb.Category
	10, // 2: pb.PackagesResponce.Packages:type_name -> pb.Package
	9,  // 3: pb.Package.category:type_name -> pb.Category
	11, // 4: pb.Package.Destinations:type_name -> pb.Destination
	12, // 5: pb.Destination.activity:type_name -> pb.Activity
	7,  // 6: pb.Coordinator.AvailablePackages:input_type -> pb.View
	7,  // 7: pb.Coordinator.CoordinatorViewPackage:input_type -> pb.View
	7,  // 8: pb.Coordinator.CoordinatorViewDestination:input_type -> pb.View
	7,  // 9: pb.Coordinator.CoordinatorViewActivity:input_type -> pb.View
	7,  // 10: pb.Coordinator.ViewCatagories:input_type -> pb.View
	5,  // 11: pb.Coordinator.PackageSearch:input_type -> pb.Search
	4,  // 12: pb.Coordinator.TravellerDetails:input_type -> pb.TravellerRequest
	1,  // 13: pb.Coordinator.OfflineBooking:input_type -> pb.Booking
	8,  // 14: pb.Coordinator.AvailablePackages:output_type -> pb.PackagesResponce
	10, // 15: pb.Coordinator.CoordinatorViewPackage:output_type -> pb.Package
	11, // 16: pb.Coordinator.CoordinatorViewDestination:output_type -> pb.Destination
	12, // 17: pb.Coordinator.CoordinatorViewActivity:output_type -> pb.Activity
	6,  // 18: pb.Coordinator.ViewCatagories:output_type -> pb.Catagories
	8,  // 19: pb.Coordinator.PackageSearch:output_type -> pb.PackagesResponce
	2,  // 20: pb.Coordinator.TravellerDetails:output_type -> pb.TravellerResponse
	0,  // 21: pb.Coordinator.OfflineBooking:output_type -> pb.BookingResponce
