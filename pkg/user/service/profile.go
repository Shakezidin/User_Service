...
func (c *UserSVC) ForgetPasswordSVC(p *pb.UserForget_Password) (*pb.UserResponse, error) {
...
func (c *UserSVC) ForgetPasswordVerifySVC(p *pb.UserForget_PasswordVerify) (*pb.UserResponse, error) {
...
func (c *UserSVC) NewPasswordSVC(p *pb.UserNew_Password) (*pb.UserResponse, error) {
...
func (c *UserSVC) UpdateProfileSVC(p *pb.UserSignup) (*pb.UserResponse, error) {
